...
| `SsalKit.Timekeeping` | [![NuGet](https://img.shields.io/nuget/v/SsalKit.Timekeeping.svg?logo=nuget)](https://www.nuget.org/packages/SsalKit.Timekeeping) | 決定的で永続化可能な時間状態を計算するライブラリ。カレンダーのリセット境界（日次/週次/月次、固定 DST 契約）と、経過時間のクールダウン・充電プール。 | [README](src/SsalKit.Timekeeping/README.ja.md) |
