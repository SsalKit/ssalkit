...
| `SsalKit.Timekeeping` | [![NuGet](https://img.shields.io/nuget/v/SsalKit.Timekeeping.svg?logo=nuget)](https://www.nuget.org/packages/SsalKit.Timekeeping) | Deterministic, persistable time state: calendar reset boundaries (daily/weekly/monthly, fixed DST contract) plus elapsed-time cooldowns and recharging pools. | [README](src/SsalKit.Timekeeping/README.md) |
