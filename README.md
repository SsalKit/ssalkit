...
| `SsalKit.Timekeeping` | [![NuGet](https://img.shields.io/nuget/v/SsalKit.Timekeeping.svg?logo=nuget)](https://www.nuget.org/packages/SsalKit.Timekeeping) | Time-zone-aware recurring reset boundaries (daily/weekly/monthly) with a fixed daylight-saving contract, plus half-open time-window arithmetic. | [README](src/SsalKit.Timekeeping/README.md) |
