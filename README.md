...
| `SsalKit.Determinism` | [![NuGet](https://img.shields.io/nuget/v/SsalKit.Determinism.svg?logo=nuget)](https://www.nuget.org/packages/SsalKit.Determinism) | Opt-in compile-time diagnostics for non-deterministic APIs used inside `[Deterministic]` scopes, each message naming a concrete replacement. | [README](src/SsalKit.Determinism/README.md) |
