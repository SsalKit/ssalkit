...
| `SsalKit.Timekeeping` | [![NuGet](https://img.shields.io/nuget/v/SsalKit.Timekeeping.svg?logo=nuget)](https://www.nuget.org/packages/SsalKit.Timekeeping) | 결정적이고 저장 가능한 시간 상태 계산 라이브러리. 달력 리셋 경계(일간/주간/월간, 고정 DST 계약)와 경과 시간 쿨다운·충전 풀. | [README](src/SsalKit.Timekeeping/README.ko.md) |
