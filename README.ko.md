...
| `SsalKit.Timekeeping` | [![NuGet](https://img.shields.io/nuget/v/SsalKit.Timekeeping.svg?logo=nuget)](https://www.nuget.org/packages/SsalKit.Timekeeping) | 타임존을 인지하는 반복 리셋 경계(일간/주간/월간)와 고정된 DST 계약, 그리고 반개구간 시간 창 산술. | [README](src/SsalKit.Timekeeping/README.ko.md) |
