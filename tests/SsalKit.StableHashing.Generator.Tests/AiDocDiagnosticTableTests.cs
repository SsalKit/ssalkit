...
/// <summary>
/// Keeps the Diagnostics table of <c>src/SsalKit.StableHashing/AI.md</c> in agreement with the live
/// descriptor table.
/// </summary>
/// <remarks>
...
public class AiDocDiagnosticTableTests
{
    ...
    private static string AiDocPath([CallerFilePath] string testFilePath = "") =>
        Path.GetFullPath(
            Path.Combine(Path.GetDirectoryName(testFilePath)!, "..", "..", "src", "SsalKit.StableHashing", "AI.md"));
}
