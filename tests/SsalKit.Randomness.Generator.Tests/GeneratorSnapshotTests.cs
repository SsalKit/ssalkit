...
public class GeneratorSnapshotTests
{
    ...
    public void SharedSourceOverloadsWrittenAsFalse_MatchesTheDefaultOutput()
    {
        ...
        Assert.Equal(
            GeneratorTestSupport.RunGenerator(withoutFlag).AssertCompilesCleanly().GetSingleSource(),
            GeneratorTestSupport.RunGenerator(withFlag).AssertCompilesCleanly().GetSingleSource());
    }
